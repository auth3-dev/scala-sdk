...
final case class CreateConnectionRequest(
    ...
    provider: dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.NONE,
    oidcDiscoveryUrl: _root_.scala.Predef.String = "",
    mfa: _root_.scala.Seq[_root_.scala.Predef.String] = _root_.scala.Seq.empty,
    `type`: dev.auth3.identity.admin.admin.CreateConnectionRequest.Types = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.UNSET,
    scopes: _root_.scala.Predef.String = "",
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[CreateConnectionRequest] {
    @transient
    ...
    def withProvider(__v: dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers): CreateConnectionRequest = copy(provider = __v)
    def withOidcDiscoveryUrl(__v: _root_.scala.Predef.String): CreateConnectionRequest = copy(oidcDiscoveryUrl = __v)
    def clearMfa = copy(mfa = _root_.scala.Seq.empty)
    def addMfa(__vs: _root_.scala.Predef.String *): CreateConnectionRequest = addAllMfa(__vs)
    def addAllMfa(__vs: Iterable[_root_.scala.Predef.String]): CreateConnectionRequest = copy(mfa = mfa ++ __vs)
    def withMfa(__v: _root_.scala.Seq[_root_.scala.Predef.String]): CreateConnectionRequest = copy(mfa = __v)
    def withType(__v: dev.auth3.identity.admin.admin.CreateConnectionRequest.Types): CreateConnectionRequest = copy(`type` = __v)
    def withScopes(__v: _root_.scala.Predef.String): CreateConnectionRequest = copy(scopes = __v)
    ...
    def companion: dev.auth3.identity.admin.admin.CreateConnectionRequest.type = dev.auth3.identity.admin.admin.CreateConnectionRequest
    // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.CreateConnectionRequest])
}
...
object CreateConnectionRequest extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.CreateConnectionRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.CreateConnectionRequest = {
    ...
    var __provider: dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.NONE
    ...
    var __type: dev.auth3.identity.admin.admin.CreateConnectionRequest.Types = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.UNSET
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 48 =>
          __provider = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.fromValue(_input__.readEnum())
        case 58 =>
          __oidcDiscoveryUrl = _input__.readStringRequireUtf8()
        case 66 =>
          __mfa += _input__.readStringRequireUtf8()
        case 72 =>
          __type = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.fromValue(_input__.readEnum())
        case 82 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.CreateConnectionRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      dev.auth3.identity.admin.admin.CreateConnectionRequest(
        ...
        provider = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.NONE.scalaValueDescriptor).number),
        ...
        `type` = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.UNSET.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 6 => dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers
      case 9 => dev.auth3.identity.admin.admin.CreateConnectionRequest.Types
    }
  }
  lazy val defaultInstance = dev.auth3.identity.admin.admin.CreateConnectionRequest(
    ...
    clientSecret = "",
    buttonImageUrl = "",
    provider = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.NONE,
    oidcDiscoveryUrl = "",
    mfa = _root_.scala.Seq.empty,
    `type` = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.UNSET,
    scopes = ""
  )
  sealed abstract class Providers(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Providers] = dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers
    final def asRecognized: _root_.scala.Option[dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers.Recognized])
  }
  ...
  object Providers extends _root_.scalapb.GeneratedEnumCompanion[Providers] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = dev.auth3.identity.admin.admin.CreateConnectionRequest.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = dev.auth3.identity.admin.admin.CreateConnectionRequest.scalaDescriptor.enums(0)
  }
  sealed abstract class Types(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Types] = dev.auth3.identity.admin.admin.CreateConnectionRequest.Types
    final def asRecognized: _root_.scala.Option[dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[dev.auth3.identity.admin.admin.CreateConnectionRequest.Types.Recognized])
  }
  ...
  object Types extends _root_.scalapb.GeneratedEnumCompanion[Types] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = dev.auth3.identity.admin.admin.CreateConnectionRequest.javaDescriptor.getEnumTypes().get(1)
  ...
  implicit class CreateConnectionRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.CreateConnectionRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.CreateConnectionRequest](_l) {
    ...
    def provider: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers] = field(_.provider)((c_, f_) => c_.copy(provider = f_))
  ...
  def of(
    ...
    clientSecret: _root_.scala.Predef.String,
    buttonImageUrl: _root_.scala.Predef.String,
    provider: dev.auth3.identity.admin.admin.CreateConnectionRequest.Providers,
    oidcDiscoveryUrl: _root_.scala.Predef.String,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.CreateConnectionRequest])
}
