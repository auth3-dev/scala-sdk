...
final case class GetIdentityResponse(
    ...
    lock: dev.auth3.identity.admin.admin.GetIdentityResponse.Lock = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.UNLOCKED,
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      credentialsIds.foreach { __item =>
        val __value = dev.auth3.identity.admin.admin.GetIdentityResponse._typemapper_credentialsIds.toBase(__item)
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      credentialsIds.foreach { __v =>
        val __m = dev.auth3.identity.admin.admin.GetIdentityResponse._typemapper_credentialsIds.toBase(__v)
    ...
    def withIdentityId(__v: _root_.scala.Predef.String): GetIdentityResponse = copy(identityId = __v)
    ...
    def clearCreatedAt: GetIdentityResponse = copy(createdAt = _root_.scala.None)
    def withCreatedAt(__v: com.google.protobuf.timestamp.Timestamp): GetIdentityResponse = copy(createdAt = Option(__v))
    ...
    def withAddressesIds(__v: _root_.scala.Seq[_root_.scala.Predef.String]): GetIdentityResponse = copy(addressesIds = __v)
    def clearCredentialsIds = copy(credentialsIds = _root_.scala.collection.immutable.Map.empty)
    def addCredentialsIds(__vs: (_root_.scala.Predef.String, _root_.scala.Predef.String) *): GetIdentityResponse = addAllCredentialsIds(__vs)
    def addAllCredentialsIds(__vs: Iterable[(_root_.scala.Predef.String, _root_.scala.Predef.String)]): GetIdentityResponse = copy(credentialsIds = credentialsIds ++ __vs)
    def withCredentialsIds(__v: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, _root_.scala.Predef.String]): GetIdentityResponse = copy(credentialsIds = __v)
    def withSchemaId(__v: _root_.scala.Predef.String): GetIdentityResponse = copy(schemaId = __v)
    def withLock(__v: dev.auth3.identity.admin.admin.GetIdentityResponse.Lock): GetIdentityResponse = copy(lock = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 6 => addressesIds
        case 7 => credentialsIds.iterator.map(dev.auth3.identity.admin.admin.GetIdentityResponse._typemapper_credentialsIds.toBase(_)).toSeq
        case 8 => {
          val __t = schemaId
          if (__t != "") __t else null
        }
    ...
    def companion: dev.auth3.identity.admin.admin.GetIdentityResponse.type = dev.auth3.identity.admin.admin.GetIdentityResponse
    // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.GetIdentityResponse])
}

object GetIdentityResponse extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdentityResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdentityResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.GetIdentityResponse = {
    ...
    var __lock: dev.auth3.identity.admin.admin.GetIdentityResponse.Lock = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.UNLOCKED
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 58 =>
          __credentialsIds += dev.auth3.identity.admin.admin.GetIdentityResponse._typemapper_credentialsIds.toCustom(_root_.scalapb.LiteParser.readMessage[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry](_input__))
        case 66 =>
          __schemaId = _input__.readStringRequireUtf8()
        case 72 =>
          __lock = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.fromValue(_input__.readEnum())
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.GetIdentityResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      dev.auth3.identity.admin.admin.GetIdentityResponse(
        ...
        lock = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.UNLOCKED.scalaValueDescriptor).number)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 7 => __out = dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      _root_.dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 9 => dev.auth3.identity.admin.admin.GetIdentityResponse.Lock
    }
  }
  lazy val defaultInstance = dev.auth3.identity.admin.admin.GetIdentityResponse(
    identityId = "",
    ...
    schemaId = "",
    lock = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.UNLOCKED
  )
  sealed abstract class Lock(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Lock] = dev.auth3.identity.admin.admin.GetIdentityResponse.Lock
    final def asRecognized: _root_.scala.Option[dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[dev.auth3.identity.admin.admin.GetIdentityResponse.Lock.Recognized])
  }
  ...
  object Lock extends _root_.scalapb.GeneratedEnumCompanion[Lock] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = dev.auth3.identity.admin.admin.GetIdentityResponse.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = dev.auth3.identity.admin.admin.GetIdentityResponse.scalaDescriptor.enums(0)
  }
  @SerialVersionUID(0L)
  final case class CredentialsIdsEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry.type = dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry
      // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.GetIdentityResponse.CredentialsIdsEntry])
  }
  
  object CredentialsIdsEntry extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry = {
      ...
      dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry(
          key = __key,
          value = __value,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = dev.auth3.identity.admin.admin.GetIdentityResponse.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = dev.auth3.identity.admin.admin.GetIdentityResponse.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry(
      key = "",
      value = ""
    )
    implicit class CredentialsIdsEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry](_l) {
    ...
    @transient
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)] =
      _root_.scalapb.TypeMapper[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)](__m => (__m.key, __m.value))(__p => dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry(__p._1, __p._2))
    def of(
      key: _root_.scala.Predef.String,
      value: _root_.scala.Predef.String
    ): _root_.dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry = _root_.dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry(
      key,
      value
    )
    // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.GetIdentityResponse.CredentialsIdsEntry])
  }
  
  implicit class GetIdentityResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetIdentityResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.GetIdentityResponse](_l) {
    ...
    def lock: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetIdentityResponse.Lock] = field(_.lock)((c_, f_) => c_.copy(lock = f_))
  }
  ...
  @transient
  private[admin] val _typemapper_credentialsIds: _root_.scalapb.TypeMapper[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)] = implicitly[_root_.scalapb.TypeMapper[dev.auth3.identity.admin.admin.GetIdentityResponse.CredentialsIdsEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)]]
  def of(
    identityId: _root_.scala.Predef.String,
    ...
    schemaId: _root_.scala.Predef.String,
    lock: dev.auth3.identity.admin.admin.GetIdentityResponse.Lock
  ): _root_.dev.auth3.identity.admin.admin.GetIdentityResponse = _root_.dev.auth3.identity.admin.admin.GetIdentityResponse(
    identityId,
    createdAt,
    updatedAt,
    mainIdentifier,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.GetIdentityResponse])
}
