...
@SerialVersionUID(0L)
final case class GetIdSchemaResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetIdSchemaResponse] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): GetIdSchemaResponse = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): GetIdSchemaResponse = copy(name = __v)
    def getContent: com.google.protobuf.struct.Struct = content.getOrElse(com.google.protobuf.struct.Struct.defaultInstance)
    def clearContent: GetIdSchemaResponse = copy(content = _root_.scala.None)
    def withContent(__v: com.google.protobuf.struct.Struct): GetIdSchemaResponse = copy(content = Option(__v))
    ...
    def clearCreatedAt: GetIdSchemaResponse = copy(createdAt = _root_.scala.None)
    def withCreatedAt(__v: com.google.protobuf.timestamp.Timestamp): GetIdSchemaResponse = copy(createdAt = Option(__v))
    ...
    def clearUpdatedAt: GetIdSchemaResponse = copy(updatedAt = _root_.scala.None)
    def withUpdatedAt(__v: com.google.protobuf.timestamp.Timestamp): GetIdSchemaResponse = copy(updatedAt = Option(__v))
    def withIsDefault(__v: _root_.scala.Boolean): GetIdSchemaResponse = copy(isDefault = __v)
    ...
    def companion: dev.auth3.identity.admin.admin.GetIdSchemaResponse.type = dev.auth3.identity.admin.admin.GetIdSchemaResponse
    // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.GetIdSchemaResponse])
}

object GetIdSchemaResponse extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdSchemaResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetIdSchemaResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.GetIdSchemaResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.GetIdSchemaResponse] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = dev.auth3.identity.admin.admin.GetIdSchemaResponse(
    id = "",
    name = "",
  ...
  implicit class GetIdSchemaResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetIdSchemaResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.GetIdSchemaResponse](_l) {
  ...
  ): _root_.dev.auth3.identity.admin.admin.GetIdSchemaResponse = _root_.dev.auth3.identity.admin.admin.GetIdSchemaResponse(
    id,
    name,
    content,
    createdAt,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.GetIdSchemaResponse])
}
