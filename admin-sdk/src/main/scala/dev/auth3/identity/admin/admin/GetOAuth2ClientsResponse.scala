...
@SerialVersionUID(0L)
final case class GetOAuth2ClientsResponse(
    clients: _root_.scala.Seq[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client] = _root_.scala.Seq.empty,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetOAuth2ClientsResponse] {
    @transient
    ...
    def addClients(__vs: dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client *): GetOAuth2ClientsResponse = addAllClients(__vs)
    def addAllClients(__vs: Iterable[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]): GetOAuth2ClientsResponse = copy(clients = clients ++ __vs)
    def withClients(__v: _root_.scala.Seq[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]): GetOAuth2ClientsResponse = copy(clients = __v)
    ...
    def companion: dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.type = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse
    // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.GetOAuth2ClientsResponse])
}

object GetOAuth2ClientsResponse extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse = {
    val __clients: _root_.scala.collection.immutable.VectorBuilder[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client] = new _root_.scala.collection.immutable.VectorBuilder[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __clients += _root_.scalapb.LiteParser.readMessage[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client](_input__)
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse(
        clients = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]]).getOrElse(_root_.scala.Seq.empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      _root_.dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse(
  ...
  final case class Client(
      ...
      clientSecretExpiresAt: _root_.scala.Long = 0L,
      ...
      unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
      ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Client] {
      ...
      private[this] def __computeSerializedSize(): _root_.scala.Int = {
        ...
        {
          val __value = clientSecretExpiresAt
          if (__value != 0L) {
      ...
      def addAllowedCorsOrigins(__vs: _root_.scala.Predef.String *): Client = addAllAllowedCorsOrigins(__vs)
      def addAllAllowedCorsOrigins(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(allowedCorsOrigins = allowedCorsOrigins ++ __vs)
      def withAllowedCorsOrigins(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(allowedCorsOrigins = __v)
      def clearAudience = copy(audience = _root_.scala.Seq.empty)
      def addAudience(__vs: _root_.scala.Predef.String *): Client = addAllAudience(__vs)
      def addAllAudience(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(audience = audience ++ __vs)
      def withAudience(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(audience = __v)
      def withBackchannelLogoutSessionRequired(__v: _root_.scala.Boolean): Client = copy(backchannelLogoutSessionRequired = __v)
      def withBackchannelLogoutUri(__v: _root_.scala.Predef.String): Client = copy(backchannelLogoutUri = __v)
      def withClientId(__v: _root_.scala.Predef.String): Client = copy(clientId = __v)
      def withClientName(__v: _root_.scala.Predef.String): Client = copy(clientName = __v)
      def withClientSecretExpiresAt(__v: _root_.scala.Long): Client = copy(clientSecretExpiresAt = __v)
      def withClientUri(__v: _root_.scala.Predef.String): Client = copy(clientUri = __v)
      def clearContacts = copy(contacts = _root_.scala.Seq.empty)
      def addContacts(__vs: _root_.scala.Predef.String *): Client = addAllContacts(__vs)
      def addAllContacts(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(contacts = contacts ++ __vs)
      def withContacts(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(contacts = __v)
      ...
      def clearCreatedAt: Client = copy(createdAt = _root_.scala.None)
      def withCreatedAt(__v: com.google.protobuf.timestamp.Timestamp): Client = copy(createdAt = Option(__v))
      def withFrontchannelLogoutSessionRequired(__v: _root_.scala.Boolean): Client = copy(frontchannelLogoutSessionRequired = __v)
      def withFrontchannelLogoutUri(__v: _root_.scala.Predef.String): Client = copy(frontchannelLogoutUri = __v)
      def clearGrantTypes = copy(grantTypes = _root_.scala.Seq.empty)
      def addGrantTypes(__vs: dev.auth3.identity.admin.admin.GrantType *): Client = addAllGrantTypes(__vs)
      def addAllGrantTypes(__vs: Iterable[dev.auth3.identity.admin.admin.GrantType]): Client = copy(grantTypes = grantTypes ++ __vs)
      def withGrantTypes(__v: _root_.scala.Seq[dev.auth3.identity.admin.admin.GrantType]): Client = copy(grantTypes = __v)
      def getJwks: com.google.protobuf.struct.Struct = jwks.getOrElse(com.google.protobuf.struct.Struct.defaultInstance)
      def clearJwks: Client = copy(jwks = _root_.scala.None)
      def withJwks(__v: com.google.protobuf.struct.Struct): Client = copy(jwks = Option(__v))
      def withJwksUri(__v: _root_.scala.Predef.String): Client = copy(jwksUri = __v)
      def withLogoUri(__v: _root_.scala.Predef.String): Client = copy(logoUri = __v)
      def getMetadata: com.google.protobuf.struct.Struct = metadata.getOrElse(com.google.protobuf.struct.Struct.defaultInstance)
      def clearMetadata: Client = copy(metadata = _root_.scala.None)
      def withMetadata(__v: com.google.protobuf.struct.Struct): Client = copy(metadata = Option(__v))
      def withOwner(__v: _root_.scala.Predef.String): Client = copy(owner = __v)
      def withPolicyUri(__v: _root_.scala.Predef.String): Client = copy(policyUri = __v)
      def clearPostLogoutRedirectUris = copy(postLogoutRedirectUris = _root_.scala.Seq.empty)
      def addPostLogoutRedirectUris(__vs: _root_.scala.Predef.String *): Client = addAllPostLogoutRedirectUris(__vs)
      def addAllPostLogoutRedirectUris(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(postLogoutRedirectUris = postLogoutRedirectUris ++ __vs)
      def withPostLogoutRedirectUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(postLogoutRedirectUris = __v)
      def clearRedirectUris = copy(redirectUris = _root_.scala.Seq.empty)
      def addRedirectUris(__vs: _root_.scala.Predef.String *): Client = addAllRedirectUris(__vs)
      def addAllRedirectUris(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(redirectUris = redirectUris ++ __vs)
      def withRedirectUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(redirectUris = __v)
      def withRequestObjectSigningAlg(__v: dev.auth3.identity.admin.admin.RequestObjectSigningAlg): Client = copy(requestObjectSigningAlg = __v)
      def clearRequestUris = copy(requestUris = _root_.scala.Seq.empty)
      def addRequestUris(__vs: _root_.scala.Predef.String *): Client = addAllRequestUris(__vs)
      def addAllRequestUris(__vs: Iterable[_root_.scala.Predef.String]): Client = copy(requestUris = requestUris ++ __vs)
      def withRequestUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Client = copy(requestUris = __v)
      def clearResponseTypes = copy(responseTypes = _root_.scala.Seq.empty)
      def addResponseTypes(__vs: dev.auth3.identity.admin.admin.ResponseType *): Client = addAllResponseTypes(__vs)
      def addAllResponseTypes(__vs: Iterable[dev.auth3.identity.admin.admin.ResponseType]): Client = copy(responseTypes = responseTypes ++ __vs)
      def withResponseTypes(__v: _root_.scala.Seq[dev.auth3.identity.admin.admin.ResponseType]): Client = copy(responseTypes = __v)
      def withScope(__v: _root_.scala.Predef.String): Client = copy(scope = __v)
      def withSectorIdentifierUri(__v: _root_.scala.Predef.String): Client = copy(sectorIdentifierUri = __v)
      def withSubjectType(__v: dev.auth3.identity.admin.admin.SubjectType): Client = copy(subjectType = __v)
      def withTokenEndpointAuthMethod(__v: dev.auth3.identity.admin.admin.TokenEndpointAuthMethod): Client = copy(tokenEndpointAuthMethod = __v)
      def withTokenEndpointAuthSigningAlg(__v: dev.auth3.identity.admin.admin.TokenEndpointAuthSigningAlg): Client = copy(tokenEndpointAuthSigningAlg = __v)
      def withTosUri(__v: _root_.scala.Predef.String): Client = copy(tosUri = __v)
      ...
      def clearUpdatedAt: Client = copy(updatedAt = _root_.scala.None)
      def withUpdatedAt(__v: com.google.protobuf.timestamp.Timestamp): Client = copy(updatedAt = Option(__v))
      def withUserinfoSignedResponseAlg(__v: dev.auth3.identity.admin.admin.UserinfoSignedResponseAlg): Client = copy(userinfoSignedResponseAlg = __v)
      def withClientType(__v: dev.auth3.identity.admin.admin.ClientType): Client = copy(clientType = __v)
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
        ...
        (__field.number: @_root_.scala.unchecked) match {
          ...
          case 7 => _root_.scalapb.descriptors.PLong(clientSecretExpiresAt)
          ...
          case 10 => createdAt.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
          ...
          case 31 => updatedAt.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
          case 32 => _root_.scalapb.descriptors.PEnum(userinfoSignedResponseAlg.scalaValueDescriptor)
          case 33 => _root_.scalapb.descriptors.PEnum(clientType.scalaValueDescriptor)
        }
      }
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client.type = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client
      // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.GetOAuth2ClientsResponse.Client])
  }
  
  object Client extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client = {
      ...
      var __clientSecretExpiresAt: _root_.scala.Long = 0L
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 56 =>
            __clientSecretExpiresAt = _input__.readInt64()
          case 66 =>
      ...
      dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client(
          ...
          clientSecretExpiresAt = __clientSecretExpiresAt,
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client(
          ...
          clientSecretExpiresAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.Long]).getOrElse(0L),
          ...
          createdAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(10).get).flatMap(_.as[_root_.scala.Option[com.google.protobuf.timestamp.Timestamp]]),
          ...
          updatedAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(31).get).flatMap(_.as[_root_.scala.Option[com.google.protobuf.timestamp.Timestamp]]),
          userinfoSignedResponseAlg = dev.auth3.identity.admin.admin.UserinfoSignedResponseAlg.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(32).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(dev.auth3.identity.admin.admin.UserinfoSignedResponseAlg.USERINFO_SIGNED_RESPONSE_ALG_UNSET.scalaValueDescriptor).number),
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
        ...
        case 31 => __out = com.google.protobuf.timestamp.Timestamp
      }
      __out
    }
    ...
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 32 => dev.auth3.identity.admin.admin.UserinfoSignedResponseAlg
        case 33 => dev.auth3.identity.admin.admin.ClientType
      }
    }
    lazy val defaultInstance = dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client(
    ...
    implicit class ClientLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client](_l) {
      ...
      def clientSecretExpiresAt: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Long] = field(_.clientSecretExpiresAt)((c_, f_) => c_.copy(clientSecretExpiresAt = f_))
    ...
    final val CLIENT_SECRET_EXPIRES_AT_FIELD_NUMBER = 7
    final val CLIENT_URI_FIELD_NUMBER = 8
    final val CONTACTS_FIELD_NUMBER = 9
    final val CREATED_AT_FIELD_NUMBER = 10
    ...
    final val UPDATED_AT_FIELD_NUMBER = 31
    final val USERINFO_SIGNED_RESPONSE_ALG_FIELD_NUMBER = 32
    ...
    def of(
      ...
      clientId: _root_.scala.Predef.String,
      clientName: _root_.scala.Predef.String,
      clientSecretExpiresAt: _root_.scala.Long,
      clientUri: _root_.scala.Predef.String,
    ...
    ): _root_.dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client = _root_.dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client(
      allowedCorsOrigins,
      audience,
    ...
    // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.GetOAuth2ClientsResponse.Client])
  }
  
  implicit class GetOAuth2ClientsResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse](_l) {
    def clients: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]] = field(_.clients)((c_, f_) => c_.copy(clients = f_))
  }
  final val CLIENTS_FIELD_NUMBER = 1
  def of(
    clients: _root_.scala.Seq[dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse.Client]
  ): _root_.dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse = _root_.dev.auth3.identity.admin.admin.GetOAuth2ClientsResponse(
    clients
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.GetOAuth2ClientsResponse])
}
