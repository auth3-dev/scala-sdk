...
@SerialVersionUID(0L)
final case class UpdateOAuth2ClientRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateOAuth2ClientRequest] {
    ...
    def addAllowedCorsOrigins(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllAllowedCorsOrigins(__vs)
    def addAllAllowedCorsOrigins(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(allowedCorsOrigins = allowedCorsOrigins ++ __vs)
    def withAllowedCorsOrigins(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(allowedCorsOrigins = __v)
    def clearAudience = copy(audience = _root_.scala.Seq.empty)
    def addAudience(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllAudience(__vs)
    def addAllAudience(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(audience = audience ++ __vs)
    def withAudience(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(audience = __v)
    def withBackchannelLogoutSessionRequired(__v: _root_.scala.Boolean): UpdateOAuth2ClientRequest = copy(backchannelLogoutSessionRequired = __v)
    def withBackchannelLogoutUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(backchannelLogoutUri = __v)
    def withClientName(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(clientName = __v)
    def withClientUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(clientUri = __v)
    def clearContacts = copy(contacts = _root_.scala.Seq.empty)
    def addContacts(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllContacts(__vs)
    def addAllContacts(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(contacts = contacts ++ __vs)
    def withContacts(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(contacts = __v)
    def withFrontchannelLogoutSessionRequired(__v: _root_.scala.Boolean): UpdateOAuth2ClientRequest = copy(frontchannelLogoutSessionRequired = __v)
    def withFrontchannelLogoutUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(frontchannelLogoutUri = __v)
    def clearGrantTypes = copy(grantTypes = _root_.scala.Seq.empty)
    def addGrantTypes(__vs: dev.auth3.identity.admin.admin.GrantType *): UpdateOAuth2ClientRequest = addAllGrantTypes(__vs)
    def addAllGrantTypes(__vs: Iterable[dev.auth3.identity.admin.admin.GrantType]): UpdateOAuth2ClientRequest = copy(grantTypes = grantTypes ++ __vs)
    def withGrantTypes(__v: _root_.scala.Seq[dev.auth3.identity.admin.admin.GrantType]): UpdateOAuth2ClientRequest = copy(grantTypes = __v)
    def getJwks: com.google.protobuf.struct.Struct = jwks.getOrElse(com.google.protobuf.struct.Struct.defaultInstance)
    def clearJwks: UpdateOAuth2ClientRequest = copy(jwks = _root_.scala.None)
    def withJwks(__v: com.google.protobuf.struct.Struct): UpdateOAuth2ClientRequest = copy(jwks = Option(__v))
    def withJwksUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(jwksUri = __v)
    def withLogoUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(logoUri = __v)
    def getMetadata: com.google.protobuf.struct.Struct = metadata.getOrElse(com.google.protobuf.struct.Struct.defaultInstance)
    def clearMetadata: UpdateOAuth2ClientRequest = copy(metadata = _root_.scala.None)
    def withMetadata(__v: com.google.protobuf.struct.Struct): UpdateOAuth2ClientRequest = copy(metadata = Option(__v))
    def withOwner(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(owner = __v)
    def withPolicyUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(policyUri = __v)
    def clearPostLogoutRedirectUris = copy(postLogoutRedirectUris = _root_.scala.Seq.empty)
    def addPostLogoutRedirectUris(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllPostLogoutRedirectUris(__vs)
    def addAllPostLogoutRedirectUris(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(postLogoutRedirectUris = postLogoutRedirectUris ++ __vs)
    def withPostLogoutRedirectUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(postLogoutRedirectUris = __v)
    def clearRedirectUris = copy(redirectUris = _root_.scala.Seq.empty)
    def addRedirectUris(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllRedirectUris(__vs)
    def addAllRedirectUris(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(redirectUris = redirectUris ++ __vs)
    def withRedirectUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(redirectUris = __v)
    def withRequestObjectSigningAlg(__v: dev.auth3.identity.admin.admin.RequestObjectSigningAlg): UpdateOAuth2ClientRequest = copy(requestObjectSigningAlg = __v)
    def clearRequestUris = copy(requestUris = _root_.scala.Seq.empty)
    def addRequestUris(__vs: _root_.scala.Predef.String *): UpdateOAuth2ClientRequest = addAllRequestUris(__vs)
    def addAllRequestUris(__vs: Iterable[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(requestUris = requestUris ++ __vs)
    def withRequestUris(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOAuth2ClientRequest = copy(requestUris = __v)
    def clearResponseTypes = copy(responseTypes = _root_.scala.Seq.empty)
    def addResponseTypes(__vs: dev.auth3.identity.admin.admin.ResponseType *): UpdateOAuth2ClientRequest = addAllResponseTypes(__vs)
    def addAllResponseTypes(__vs: Iterable[dev.auth3.identity.admin.admin.ResponseType]): UpdateOAuth2ClientRequest = copy(responseTypes = responseTypes ++ __vs)
    def withResponseTypes(__v: _root_.scala.Seq[dev.auth3.identity.admin.admin.ResponseType]): UpdateOAuth2ClientRequest = copy(responseTypes = __v)
    def withScope(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(scope = __v)
    def withSectorIdentifierUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(sectorIdentifierUri = __v)
    def withSubjectType(__v: dev.auth3.identity.admin.admin.SubjectType): UpdateOAuth2ClientRequest = copy(subjectType = __v)
    def withTokenEndpointAuthMethod(__v: dev.auth3.identity.admin.admin.TokenEndpointAuthMethod): UpdateOAuth2ClientRequest = copy(tokenEndpointAuthMethod = __v)
    def withTokenEndpointAuthSigningAlg(__v: dev.auth3.identity.admin.admin.TokenEndpointAuthSigningAlg): UpdateOAuth2ClientRequest = copy(tokenEndpointAuthSigningAlg = __v)
    def withTosUri(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(tosUri = __v)
    def withUserinfoSignedResponseAlg(__v: dev.auth3.identity.admin.admin.UserinfoSignedResponseAlg): UpdateOAuth2ClientRequest = copy(userinfoSignedResponseAlg = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(clientSecret = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateOAuth2ClientRequest = copy(clientId = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 33 => _root_.scalapb.descriptors.PString(clientId)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest.type = dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest
    // @@protoc_insertion_point(GeneratedMessage[depot.devtools.auth.v0.identity.admin.UpdateOAuth2ClientRequest])
}

object UpdateOAuth2ClientRequest extends scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest(
        ...
        clientId = __fieldsMap.get(scalaDescriptor.findFieldByNumber(33).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
  ...
  lazy val defaultInstance = dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest(
  ...
  implicit class UpdateOAuth2ClientRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest](_l) {
  ...
  final val CLIENT_ID_FIELD_NUMBER = 33
  def of(
    ...
    clientSecret: _root_.scala.Predef.String,
    clientId: _root_.scala.Predef.String
  ): _root_.dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest = _root_.dev.auth3.identity.admin.admin.UpdateOAuth2ClientRequest(
    allowedCorsOrigins,
    audience,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[depot.devtools.auth.v0.identity.admin.UpdateOAuth2ClientRequest])
}
